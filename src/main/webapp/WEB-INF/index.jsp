...
<body>
    ...
    <div class= "body-title"><h3>Gym Bois' Deals</h3></div>
        ...
        <div class="row">
          <!--image card start-->
          <div class="image">
            <img class="img" src="img/home-gym-setup.jpg" alt="">
            <div class="details">
          ...
          <!--image card start-->
          <div class="image">
            <img class="img2" src="img/training.jpg" alt="">
            <div class="details">
          ...
          <!--image card start-->
          <div class="image">
            <img class="img3" src="img/alpha-brain.jpg" alt="">
            <div class="details">
              <h2>Supplements</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <div class="more">
        ...
        <div class="row">
          <!--image card start-->
          <div class="image">
            <img class="img4" src="img/womens.jpg" alt="">
            <div class="details">
          ...
          <!--image card start-->
          <div class="image">
            <img class="img5" src="img/gymgear.jpg" alt="">
            <div class="details">
              <h2>GYM GEAR</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <div class="more">
          ...
          <!--image card start-->
          <div class="image">
            <img class="img6" src="img/mens.jpg" alt="">
            <div class="details">
              <h2>Men's Apparel</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <div class="more">
